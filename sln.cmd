...
dotnet sln add B:/dev/z0/libs/api.checks/z0.api.checks.csproj
...
dotnet sln add B:/dev/z0/libs/commands/z0.commands.csproj
dotnet sln add B:/dev/z0/libs/calcs/z0.calcs.csproj
dotnet sln add B:/dev/z0/libs/circuits/z0.circuits.csproj
dotnet sln add B:/dev/z0/libs/cmd.actions/z0.cmd.actions.csproj
dotnet sln add B:/dev/z0/libs/cmd.exec/z0.cmd.exec.csproj
dotnet sln add B:/dev/z0/libs/cmd.tools/z0.cmd.tools.csproj
dotnet sln add B:/dev/z0/libs/cmd.flows/z0.cmd.flows.csproj
dotnet sln add B:/dev/z0/libs/cmd.checks/z0.cmd.checks.csproj
...
dotnet sln add B:/dev/z0/libs/lines/z0.lines.csproj
...
dotnet sln add B:/dev/z0/libs/memory.checks/z0.memory.checks.csproj
dotnet sln add B:/dev/z0/libs/memory.models/z0.memory.models.csproj
...
dotnet sln add B:/dev/z0/libs/shell.cmd/z0.shell.cmd.csproj
dotnet sln add B:/dev/z0/libs/workers/z0.workers.csproj
...
dotnet sln add B:/dev/z0/test/test.shell/z0.test.shell.csproj
...
dotnet sln add B:/dev/z0/cg/cg.shell/z0.cg.shell.csproj
dotnet sln add B:/dev/z0/cg/cg.test/z0.cg.test.csproj