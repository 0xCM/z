...
namespace Z0
{
    ...
    public abstract class Interpreter<S>
        where S : Interpreter<S>, new()
    {
        ...
        {
            MsgChannel.Status("Process exit event received");
        }

        void OnStatus(object sender, DataReceivedEventArgs e)
        {
            if(e != null && e.Data != null)
                MsgChannel.Status(e.Data);
        }
