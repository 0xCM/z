...
@REM dotnet sln add B:/dev/z0/libs/literals/z0.literals.csproj
@REM dotnet sln add B:/dev/z0/libs/sys/z0.sys.csproj
...
@REM dotnet sln add B:/dev/z0/libs/wf.shell/z0.wf.shell.csproj
...
@REM dotnet sln add B:/dev/z0/libs/commands/z0.commands.csproj
@REM dotnet sln add B:/dev/z0/libs/calcs/z0.calcs.csproj
@REM dotnet sln add B:/dev/z0/libs/circuits/z0.circuits.csproj
@REM dotnet sln add B:/dev/z0/libs/cmd.actions/z0.cmd.actions.csproj
@REM dotnet sln add B:/dev/z0/libs/cmd.exec/z0.cmd.exec.csproj
@REM dotnet sln add B:/dev/z0/libs/cmd.tools/z0.cmd.tools.csproj
@REM dotnet sln add B:/dev/z0/libs/cmd.flows/z0.cmd.flows.csproj
...
@REM dotnet sln add B:/dev/z0/libs/llvm.tools/z0.llvm.tools.csproj
@REM dotnet sln add B:/dev/z0/libs/llvm.svc/z0.llvm.svc.csproj
@REM dotnet sln add B:/dev/z0/libs/lang/z0.lang.csproj
@REM dotnet sln add B:/dev/z0/libs/lines/z0.lines.csproj
...
@REM dotnet sln add B:/dev/z0/libs/memory.models/z0.memory.models.csproj
