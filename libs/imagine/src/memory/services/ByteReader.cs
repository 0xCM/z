...
namespace Z0
{
    ...
    public readonly struct ByteReader
    {
        ...
        {
            Spans.first(Spans.recover<ushort>(dst)) = u16(src);
            return 2;
        }
        ...
        {
            Spans.first(Spans.recover<uint>(dst)) = u32(src);
            return 4;
        }
        ...
        {
            read4(src,dst);
            read2(skip(src,4), Spans.slice(dst,4));
            return 6;
        }
        ...
        {
            read4(src,dst);
            read3(skip(src,4), Spans.slice(dst,4));
            return 7;
        }
        ...
        {
            Spans.first(Spans.recover<ulong>(dst)) = u64(src);
            return 8;
        }
        ...
        //     var i=0u;
        //     Spans.seek32(buffer,i++) = skip32(src,i);
        //     Spans.seek32(buffer,i++) = skip32(src,i);
        //     Spans.seek32(buffer,i++) = skip32(src,i);
        //     return dst;
        // }
