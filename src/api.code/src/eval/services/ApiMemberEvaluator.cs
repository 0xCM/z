...
namespace Z0
{
    ...
    public readonly struct ApiMemberEvaluator
    {
        ...
        public Triples<T> Eval<T>(in MemberCodeBlock api, BinaryOperatorClass op, Pairs<T> src, Triples<T> dst)
            where T : unmanaged
        {
        ...
        /// <param name="src">The source pairs over which to evaluate the operator</param>
        /// <typeparam name="T">The operand type</typeparam>
        public Triples<T> Eval<T>(in MemberCodeBlock api, BinaryOperatorClass op, Pairs<T> src)
            where T : unmanaged
        ...
        /// <param name="src">The source pairs over which to evaluate the operator</param>
        /// <typeparam name="T">The operand type</typeparam>
        public Triples<F> EvalCellular<F>(in MemberCodeBlock api, BinaryOperatorClass op, Pairs<F> src)
