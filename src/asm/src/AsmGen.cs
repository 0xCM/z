    ...
    public Index<AsmInstruction> Concretize(in SdmForm form)
    {
        ...
        switch(opcount)
        {
            ...
            case 1:
            {
                ...
                {
                    dst.Add(asm.inst(form.Mnemonic, ops0[a], out _));
                }
            ...
            case 2:
            {
                ...
                {
                    dst.Add(asm.inst(form.Mnemonic, ops0[a], ops1[b], out _));
                }
            }
            break;
            case 3:
            {
                ...
                {
                    dst.Add(asm.inst(form.Mnemonic, ops0[a], ops1[b], ops2[c], out _));
                }
            }
            break;
            case 4:
            {
                ...
                {
                    dst.Add(asm.inst(form.Mnemonic, ops0[a], ops1[b], ops2[c], ops3[d], out _));
                }
            }
            break;
        }
