...
public class AsmRegTokens
{
    ...
    /// </summary>
    [SymSource(GroupName), TokenKind(K.Gp)]
    ...
    /// </remarks/>
    [SymSource(GroupName), TokenKind(K.Gp16)]
    ...
    /// </remarks/>
    [SymSource(GroupName), TokenKind(K.Gp32)]
    ...
    /// </remarks/>
    [SymSource(GroupName), TokenKind(K.Gp64)]
    ...
    /// </remarks/>
    [SymSource(GroupName), TokenKind(K.Xmm)]
    ...
    /// </summary>
    [SymSource(GroupName), TokenKind(K.Ymm)]
    ...
    /// </summary>
    [SymSource(GroupName), TokenKind(K.Zmm)]
    ...
    /// bnd0, bnd1, bnd2, bnd3
    /// </summary>
    [SymSource(GroupName), TokenKind(K.Bnd)]
    ...
    /// </summary>
    [SymSource(GroupName), TokenKind(K.Cr)]
    ...
    /// xcr0
    /// </summary>
    [SymSource(GroupName), TokenKind(K.XCr)]
    ...
    /// </summary>
    [SymSource(GroupName), TokenKind(K.Db)]
    ...
    /// </summary>
    [SymSource(GroupName), TokenKind(K.Mask)]
    ...
    [SymSource(GroupName), TokenKind(K.Test)]
    ...
    [SymSource(GroupName), TokenKind(K.Fp)]
    ...
    /// cs, ds, ss, es, fs, gs
    /// </summary>
    [SymSource(GroupName), TokenKind(K.Seg)]
    ...
    /// gdtr, ldtr, idtr
    /// </summary>
    [SymSource(GroupName), TokenKind(K.SysPtr)]
    ...
    /// "The interrupt descriptor table register"
    /// </summary>
    [SymSource(GroupName), TokenKind(K.Mmx)]
    ...
    /// ip, eip, rip
    /// </summary>
    [SymSource(GroupName), TokenKind(K.Ip)]
