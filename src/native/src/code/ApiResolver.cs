...
//         public uint ResolvePart(Assembly src, List<ResolvedPart> dst)
//         {
...
//             var catalog = ApiCatalog.catalog(src);
...
//             var catalog = ApiCatalog.catalog(src.Owner);
...
//         {
//             var counter = 0u;
//             foreach(var part in src.Assemblies)
