...
namespace Z0.Lang.Intel
{
    ...
    public readonly struct Types
    {
        ...
        static void intrinsics(NativeTypeMap.MapBuilder map)
        {
            ...
            map.Map(Names.__tile, i32());

            map.Map(Names.__mmask8, u8());
            map.Map(Names.__mmask16, u16());
            map.Map(Names.__mmask32, u32());
            map.Map(Names.__mmask64, u64());
            ...
            map.Map(Names.__m256, seg256x32f());
            map.Map(Names.__m256d, seg256x64f());
