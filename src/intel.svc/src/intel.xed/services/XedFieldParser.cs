...
public class XedFieldParser
{
    ...
    public static XedFieldState parse(IReadOnlyDictionary<string,string> src, out Index<FK> fields)
    {
        var parsed = list<FK>();
    ...
    [Op]
    public static FieldValue parse(string src, FK kind, ref XedFieldState dst)
    {
        var result = true;
