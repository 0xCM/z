...
partial class XedDataFlow
{
    ...
    public void EmitInstDump(XedInstDump src)
    {
        exec(PllExec,
            () => EmitRecords(src),
            () => EmitBlockDetail(src),
    ...
    void EmitLineMap(XedInstDump src)
    ...
    void EmitRecords(XedInstDump src)
    {
    ...
    void EmitBlockDetail(XedInstDump src)
    {
    ...
    class BlockImportDatasets
    {
        ...
        // public static void calc(Action<XedInstDump> dst)
        //     => dst(calc(XedDb.RuleDumpFile()));

        // static XedInstDump calc(MemoryFile src)
        // {
        //     var dst = new XedInstDump();
        //     var ds = new BlockImportDatasets();
        //     var lines = Lines.lines(src);
