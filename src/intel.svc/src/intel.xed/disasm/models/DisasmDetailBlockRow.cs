...
namespace Z0
{
    ...
    partial class XedDisasmModels
    {
        ...
        public record struct DisasmDetailBlockRow : IComparable<DisasmDetailBlockRow>
        {
            ...
            public int CompareTo(DisasmDetailBlockRow src)
            {
            ...
            public static DisasmDetailBlockRow Empty => default;
        }
    }
}