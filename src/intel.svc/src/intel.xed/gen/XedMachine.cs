...
public class XedMachine
{
    ...
    public XedMachine(MachineContext context)
    {
        ...
        Rules[0x0418] = AVX512_ROUND_DEC;
        Rules[0x0218] = AVX512_ROUND_ENC;
        Rules[0x0419] = BND_B_DEC;
        Rules[0x041a] = BND_B_CHECK_DEC;
        Rules[0x021a] = BND_B_CHECK_ENC;
        Rules[0x041b] = BND_R_DEC;
        Rules[0x041c] = BND_R_CHECK_DEC;
        Rules[0x021c] = BND_R_CHECK_ENC;
        Rules[0x041d] = BRANCH_HINT_DEC;
        Rules[0x021d] = BRANCH_HINT_ENC;
        Rules[0x041e] = BRDISP32_DEC;
        Rules[0x041f] = BRDISP8_DEC;
        Rules[0x0420] = BRDISPz_DEC;
        Rules[0x0421] = CET_NO_TRACK_DEC;
        Rules[0x0221] = CET_NO_TRACK_ENC;
        Rules[0x0422] = CR_B_DEC;
        Rules[0x0423] = CR_R_DEC;
        Rules[0x0424] = CR_WIDTH_DEC;
        Rules[0x0224] = CR_WIDTH_ENC;
        Rules[0x0425] = DF64_DEC;
        Rules[0x0225] = DF64_ENC;
        Rules[0x0226] = DISP_NT_ENC;
        Rules[0x0227] = DISP_WIDTH_0_ENC;
        Rules[0x0228] = DISP_WIDTH_0_8_16_ENC;
        Rules[0x0229] = DISP_WIDTH_0_8_32_ENC;
        Rules[0x022a] = DISP_WIDTH_16_ENC;
        Rules[0x022b] = DISP_WIDTH_32_ENC;
        Rules[0x022c] = DISP_WIDTH_8_ENC;
        Rules[0x022d] = DISP_WIDTH_8_32_ENC;
        Rules[0x042e] = DR_R_DEC;
        Rules[0x022f] = ERROR_ENC;
        Rules[0x0430] = ESIZE_1_BITS_DEC;
        Rules[0x0230] = ESIZE_1_BITS_ENC;
        Rules[0x0431] = ESIZE_128_BITS_DEC;
        Rules[0x0231] = ESIZE_128_BITS_ENC;
        Rules[0x0432] = ESIZE_16_BITS_DEC;
        Rules[0x0232] = ESIZE_16_BITS_ENC;
        Rules[0x0433] = ESIZE_2_BITS_DEC;
        Rules[0x0233] = ESIZE_2_BITS_ENC;
        Rules[0x0434] = ESIZE_32_BITS_DEC;
        Rules[0x0234] = ESIZE_32_BITS_ENC;
        Rules[0x0435] = ESIZE_4_BITS_DEC;
        Rules[0x0235] = ESIZE_4_BITS_ENC;
        Rules[0x0436] = ESIZE_64_BITS_DEC;
        Rules[0x0236] = ESIZE_64_BITS_ENC;
        Rules[0x0437] = ESIZE_8_BITS_DEC;
        Rules[0x0237] = ESIZE_8_BITS_ENC;
        Rules[0x0238] = EVEX_62_REXR_ENC_ENC;
        Rules[0x023b] = EVEX_LL_ENC_ENC;
        Rules[0x023c] = EVEX_U_ENC_ENC;
        Rules[0x023d] = EVEX_PP_ENC_ENC;
        Rules[0x023e] = EVEX_MAP_ENC_ENC;
        Rules[0x023f] = EVEX_REXB_ENC_ENC;
        Rules[0x0240] = EVEX_REXRR_ENC_ENC;
        Rules[0x0241] = EVEX_REXW_VVVV_ENC_ENC;
        Rules[0x0242] = EVEX_REXX_ENC_ENC;
        Rules[0x0443] = EVEX_SPLITTER_DEC;
        Rules[0x0445] = FINAL_DSEG_DEC;
        Rules[0x0446] = FINAL_DSEG_MODE64_DEC;
        Rules[0x0447] = FINAL_DSEG_NOT64_DEC;
        Rules[0x0448] = FINAL_DSEG1_DEC;
        Rules[0x0449] = FINAL_DSEG1_MODE64_DEC;
        Rules[0x044a] = FINAL_DSEG1_NOT64_DEC;
        Rules[0x044b] = FINAL_ESEG_DEC;
        Rules[0x044c] = FINAL_ESEG1_DEC;
        Rules[0x044d] = FINAL_SSEG_DEC;
        Rules[0x044e] = FINAL_SSEG_MODE64_DEC;
        Rules[0x044f] = FINAL_SSEG_NOT64_DEC;
        Rules[0x0450] = FINAL_SSEG0_DEC;
        Rules[0x0451] = FINAL_SSEG1_DEC;
        Rules[0x0452] = FIX_ROUND_LEN128_DEC;
        Rules[0x0252] = FIX_ROUND_LEN128_ENC;
        Rules[0x0453] = FIX_ROUND_LEN512_DEC;
        Rules[0x0253] = FIX_ROUND_LEN512_ENC;
        Rules[0x0254] = FIXUP_EASZ_ENC_ENC;
        Rules[0x0255] = FIXUP_EOSZ_ENC_ENC;
        Rules[0x0256] = FIXUP_SMODE_ENC_ENC;
        Rules[0x0457] = FORCE64_DEC;
        Rules[0x0257] = FORCE64_ENC;
        Rules[0x0458] = GPR16_B_DEC;
        Rules[0x0459] = GPR16_R_DEC;
        Rules[0x045a] = GPR16_SB_DEC;
        Rules[0x025b] = GPR16e_ENC;
        Rules[0x045c] = GPR32_B_DEC;
        Rules[0x045d] = GPR32_R_DEC;
        Rules[0x045e] = GPR32_SB_DEC;
        Rules[0x045f] = GPR32_X_DEC;
        Rules[0x0260] = GPR32e_ENC;
        Rules[0x0261] = GPR32e_m32_ENC;
        Rules[0x0262] = GPR32e_m64_ENC;
        Rules[0x0463] = GPR64_B_DEC;
        Rules[0x0464] = GPR64_R_DEC;
        Rules[0x0465] = GPR64_SB_DEC;
        Rules[0x0466] = GPR64_X_DEC;
        Rules[0x0267] = GPR64e_ENC;
        Rules[0x0468] = GPR8_B_DEC;
        Rules[0x0268] = GPR8_B_ENC;
        Rules[0x0469] = GPR8_R_DEC;
        Rules[0x0269] = GPR8_R_ENC;
        Rules[0x046a] = GPR8_SB_DEC;
        Rules[0x026a] = GPR8_SB_ENC;
        Rules[0x046b] = GPRv_B_DEC;
        Rules[0x046c] = GPRv_R_DEC;
        Rules[0x046d] = GPRv_SB_DEC;
        Rules[0x046e] = GPRy_B_DEC;
        Rules[0x046f] = GPRy_R_DEC;
        Rules[0x0470] = GPRz_B_DEC;
        Rules[0x0471] = GPRz_R_DEC;
        Rules[0x0472] = IGNORE66_DEC;
        Rules[0x0272] = IGNORE66_ENC;
        Rules[0x0473] = IMMUNE_REXW_DEC;
        Rules[0x0273] = IMMUNE_REXW_ENC;
        Rules[0x0474] = IMMUNE66_DEC;
        Rules[0x0274] = IMMUNE66_ENC;
        Rules[0x0475] = IMMUNE66_LOOP64_DEC;
        Rules[0x0275] = IMMUNE66_LOOP64_ENC;
        Rules[0x0478] = MASK_B_DEC;
        Rules[0x0479] = MASK_N_DEC;
        Rules[0x047a] = MASK_N32_DEC;
        Rules[0x047b] = MASK_N64_DEC;
        Rules[0x047c] = MASK_R_DEC;
        Rules[0x047d] = MASK1_DEC;
        Rules[0x047e] = MASKNOT0_DEC;
        Rules[0x047f] = MEMDISP_DEC;
        Rules[0x0480] = MEMDISP16_DEC;
        Rules[0x0481] = MEMDISP32_DEC;
        Rules[0x0482] = MEMDISP8_DEC;
        Rules[0x0483] = MEMDISPv_DEC;
        Rules[0x0484] = MMX_B_DEC;
        Rules[0x0485] = MMX_R_DEC;
        Rules[0x0486] = MODRM_DEC;
        Rules[0x0287] = MODRM_MOD_EA16_DISP0_ENC;
        Rules[0x0288] = MODRM_MOD_EA16_DISP16_ENC;
        Rules[0x0289] = MODRM_MOD_EA16_DISP8_ENC;
        Rules[0x028a] = MODRM_MOD_EA32_DISP0_ENC;
        Rules[0x028b] = MODRM_MOD_EA32_DISP32_ENC;
        Rules[0x028c] = MODRM_MOD_EA32_DISP8_ENC;
        Rules[0x028d] = MODRM_MOD_EA64_DISP0_ENC;
        Rules[0x028e] = MODRM_MOD_EA64_DISP32_ENC;
        Rules[0x028f] = MODRM_MOD_EA64_DISP8_ENC;
        Rules[0x0290] = MODRM_MOD_ENCODE_ENC;
        Rules[0x0291] = MODRM_RM_ENCODE_ENC;
        Rules[0x0292] = MODRM_RM_ENCODE_EA16_SIB0_ENC;
        Rules[0x0293] = MODRM_RM_ENCODE_EA32_SIB0_ENC;
        Rules[0x0294] = MODRM_RM_ENCODE_EA64_SIB0_ENC;
        Rules[0x0295] = MODRM_RM_ENCODE_EANOT16_SIB1_ENC;
        Rules[0x0496] = MODRM16_DEC;
        Rules[0x0497] = MODRM32_DEC;
        Rules[0x0498] = MODRM64alt32_DEC;
        Rules[0x0299] = UISA_ENC_INDEX_XMM_ENC;
        Rules[0x049a] = NELEM_EIGHTHMEM_DEC;
        Rules[0x029a] = NELEM_EIGHTHMEM_ENC;
        Rules[0x049b] = NELEM_FULL_DEC;
        Rules[0x029b] = NELEM_FULL_ENC;
        Rules[0x049c] = NELEM_FULLMEM_DEC;
        Rules[0x029c] = NELEM_FULLMEM_ENC;
        Rules[0x049d] = NELEM_GPR_READER_DEC;
        Rules[0x029d] = NELEM_GPR_READER_ENC;
        Rules[0x049e] = NELEM_GPR_READER_BYTE_DEC;
        Rules[0x029e] = NELEM_GPR_READER_BYTE_ENC;
        Rules[0x049f] = NELEM_GPR_READER_SUBDWORD_DEC;
        Rules[0x029f] = NELEM_GPR_READER_SUBDWORD_ENC;
        Rules[0x04a0] = NELEM_GPR_READER_WORD_DEC;
        Rules[0x02a0] = NELEM_GPR_READER_WORD_ENC;
        Rules[0x04a1] = NELEM_GPR_WRITER_LDOP_DEC;
        Rules[0x02a1] = NELEM_GPR_WRITER_LDOP_ENC;
        Rules[0x04a2] = NELEM_GPR_WRITER_LDOP_D_DEC;
        Rules[0x02a2] = NELEM_GPR_WRITER_LDOP_D_ENC;
        Rules[0x04a3] = NELEM_GPR_WRITER_LDOP_Q_DEC;
        Rules[0x02a3] = NELEM_GPR_WRITER_LDOP_Q_ENC;
        Rules[0x04a4] = NELEM_GPR_WRITER_STORE_DEC;
        Rules[0x02a4] = NELEM_GPR_WRITER_STORE_ENC;
        Rules[0x04a5] = NELEM_GPR_WRITER_STORE_BYTE_DEC;
        Rules[0x02a5] = NELEM_GPR_WRITER_STORE_BYTE_ENC;
        Rules[0x04a6] = NELEM_GPR_WRITER_STORE_SUBDWORD_DEC;
        Rules[0x02a6] = NELEM_GPR_WRITER_STORE_SUBDWORD_ENC;
        Rules[0x04a7] = NELEM_GPR_WRITER_STORE_WORD_DEC;
        Rules[0x02a7] = NELEM_GPR_WRITER_STORE_WORD_ENC;
        Rules[0x04a8] = NELEM_GSCAT_DEC;
        Rules[0x02a8] = NELEM_GSCAT_ENC;
        Rules[0x04a9] = NELEM_HALF_DEC;
        Rules[0x02a9] = NELEM_HALF_ENC;
        Rules[0x04aa] = NELEM_HALFMEM_DEC;
        Rules[0x02aa] = NELEM_HALFMEM_ENC;
        Rules[0x04ab] = NELEM_MEM128_DEC;
        Rules[0x02ab] = NELEM_MEM128_ENC;
        Rules[0x04ac] = NELEM_MOVDDUP_DEC;
        Rules[0x02ac] = NELEM_MOVDDUP_ENC;
        Rules[0x04ad] = NELEM_QUARTERMEM_DEC;
        Rules[0x02ad] = NELEM_QUARTERMEM_ENC;
        Rules[0x04ae] = NELEM_SCALAR_DEC;
        Rules[0x02ae] = NELEM_SCALAR_ENC;
        Rules[0x04af] = NELEM_TUPLE1_DEC;
        Rules[0x02af] = NELEM_TUPLE1_ENC;
        Rules[0x04b0] = NELEM_TUPLE1_4X_DEC;
        Rules[0x02b0] = NELEM_TUPLE1_4X_ENC;
        Rules[0x04b1] = NELEM_TUPLE1_BYTE_DEC;
        Rules[0x02b1] = NELEM_TUPLE1_BYTE_ENC;
        Rules[0x04b2] = NELEM_TUPLE1_SUBDWORD_DEC;
        Rules[0x02b2] = NELEM_TUPLE1_SUBDWORD_ENC;
        Rules[0x04b3] = NELEM_TUPLE1_WORD_DEC;
        Rules[0x02b3] = NELEM_TUPLE1_WORD_ENC;
        Rules[0x04b4] = NELEM_TUPLE2_DEC;
        Rules[0x02b4] = NELEM_TUPLE2_ENC;
        Rules[0x04b5] = NELEM_TUPLE4_DEC;
        Rules[0x02b5] = NELEM_TUPLE4_ENC;
        Rules[0x04b6] = NELEM_TUPLE8_DEC;
        Rules[0x02b6] = NELEM_TUPLE8_ENC;
        Rules[0x04b8] = OeAX_DEC;
        Rules[0x04b9] = ONE_DEC;
        Rules[0x04ba] = OrAX_DEC;
        Rules[0x04bb] = OrBP_DEC;
        Rules[0x04bc] = OrBX_DEC;
        Rules[0x04bd] = OrCX_DEC;
        Rules[0x04be] = OrDX_DEC;
        Rules[0x04bf] = OrSP_DEC;
        Rules[0x04c0] = OSZ_NONTERM_DEC;
        Rules[0x02c1] = OSZ_NONTERM_ENC_ENC;
        Rules[0x04c2] = OVERRIDE_SEG0_DEC;
        Rules[0x02c2] = OVERRIDE_SEG0_ENC;
        Rules[0x04c3] = OVERRIDE_SEG1_DEC;
        Rules[0x02c3] = OVERRIDE_SEG1_ENC;
        Rules[0x02c4] = PREFIX_ENC_ENC;
        Rules[0x04c5] = PREFIXES_DEC;
        Rules[0x04c6] = REFINING66_DEC;
        Rules[0x02c6] = REFINING66_ENC;
        Rules[0x04c7] = REMOVE_SEGMENT_DEC;
        Rules[0x02c7] = REMOVE_SEGMENT_ENC;
        Rules[0x02c8] = REMOVE_SEGMENT_AGEN1_ENC;
        Rules[0x02c9] = REX_PREFIX_ENC_ENC;
        Rules[0x04ca] = rFLAGS_DEC;
        Rules[0x04cb] = rIP_DEC;
        Rules[0x04cc] = rIPa_DEC;
        Rules[0x04cd] = SAE_DEC;
        Rules[0x02cd] = SAE_ENC;
        Rules[0x04ce] = SE_IMM8_DEC;
        Rules[0x02ce] = SE_IMM8_ENC;
        Rules[0x04cf] = SEG_DEC;
        Rules[0x04d0] = SEG_MOV_DEC;
        Rules[0x02d1] = SEGe_ENC;
        Rules[0x02d2] = SEGMENT_DEFAULT_ENCODE_ENC;
        Rules[0x02d3] = SEGMENT_ENCODE_ENC;
        Rules[0x04d4] = SIB_DEC;
        Rules[0x04d5] = SIB_BASE0_DEC;
        Rules[0x02d6] = SIB_NT_ENC;
        Rules[0x02d7] = SIB_REQUIRED_ENCODE_ENC;
        Rules[0x02d8] = SIBBASE_ENCODE_ENC;
        Rules[0x02d9] = SIBBASE_ENCODE_SIB1_ENC;
        Rules[0x02da] = SIBINDEX_ENCODE_ENC;
        Rules[0x02db] = SIBINDEX_ENCODE_SIB1_ENC;
        Rules[0x02dc] = SIBSCALE_ENCODE_ENC;
        Rules[0x04dd] = SIMM8_DEC;
        Rules[0x04de] = SIMMz_DEC;
        Rules[0x04df] = SrBP_DEC;
        Rules[0x04e1] = SrSP_DEC;
        Rules[0x04e3] = TMM_B_DEC;
        Rules[0x04e4] = TMM_N_DEC;
        Rules[0x04e5] = TMM_R_DEC;
        Rules[0x04e6] = UIMM16_DEC;
        Rules[0x04e7] = UIMM32_DEC;
        Rules[0x04e8] = UIMM8_DEC;
        Rules[0x04e9] = UIMM8_1_DEC;
        Rules[0x04ea] = UIMMv_DEC;
        Rules[0x02eb] = UISA_ENC_INDEX_YMM_ENC;
        Rules[0x02ec] = UISA_ENC_INDEX_ZMM_ENC;
        Rules[0x04ed] = UISA_VMODRM_XMM_DEC;
        Rules[0x04ee] = UISA_VMODRM_YMM_DEC;
        Rules[0x04ef] = UISA_VMODRM_ZMM_DEC;
        Rules[0x04f0] = UISA_VSIB_BASE_DEC;
        Rules[0x04f1] = UISA_VSIB_INDEX_XMM_DEC;
        Rules[0x04f2] = UISA_VSIB_INDEX_YMM_DEC;
        Rules[0x04f3] = UISA_VSIB_INDEX_ZMM_DEC;
        Rules[0x04f4] = UISA_VSIB_XMM_DEC;
        Rules[0x04f5] = UISA_VSIB_YMM_DEC;
        Rules[0x04f6] = UISA_VSIB_ZMM_DEC;
        Rules[0x02f7] = VEX_ESCVL_ENC_ENC;
        Rules[0x02f8] = VEX_MAP_ENC_ENC;
        Rules[0x02f9] = VEX_REG_ENC_ENC;
        Rules[0x02fa] = VEX_REXR_ENC_ENC;
        Rules[0x02fb] = VEX_REXXB_ENC_ENC;
        Rules[0x02fc] = VEX_TYPE_ENC_ENC;
        Rules[0x02fd] = VEXED_REX_ENC;
        Rules[0x04fe] = VGPR32_B_DEC;
        Rules[0x04ff] = VGPR32_B_32_DEC;
        Rules[0x0500] = VGPR32_B_64_DEC;
        Rules[0x0501] = VGPR32_N_DEC;
        Rules[0x0502] = VGPR32_N_32_DEC;
        Rules[0x0503] = VGPR32_N_64_DEC;
        Rules[0x0504] = VGPR32_R_DEC;
        Rules[0x0505] = VGPR32_R_32_DEC;
        Rules[0x0506] = VGPR32_R_64_DEC;
        Rules[0x0507] = VGPR64_B_DEC;
        Rules[0x0508] = VGPR64_N_DEC;
        Rules[0x0509] = VGPR64_R_DEC;
        Rules[0x050a] = VGPRy_B_DEC;
        Rules[0x050b] = VGPRy_N_DEC;
        Rules[0x050c] = VGPRy_R_DEC;
        Rules[0x030d] = VMODRM_MOD_ENCODE_ENC;
        Rules[0x050e] = VMODRM_XMM_DEC;
        Rules[0x050f] = VMODRM_YMM_DEC;
        Rules[0x0510] = VSIB_BASE_DEC;
        Rules[0x0311] = VSIB_ENC_ENC;
        Rules[0x0312] = VSIB_ENC_BASE_ENC;
        Rules[0x0313] = VSIB_ENC_INDEX_XMM_ENC;
        Rules[0x0314] = VSIB_ENC_INDEX_YMM_ENC;
        Rules[0x0315] = VSIB_ENC_SCALE_ENC;
        Rules[0x0516] = VSIB_INDEX_XMM_DEC;
        Rules[0x0517] = VSIB_INDEX_YMM_DEC;
        Rules[0x0518] = VSIB_XMM_DEC;
        Rules[0x0519] = VSIB_YMM_DEC;
        Rules[0x051a] = X87_DEC;
        Rules[0x051b] = XMM_B_DEC;
        Rules[0x051c] = XMM_B_32_DEC;
        Rules[0x051d] = XMM_B_64_DEC;
        Rules[0x051e] = XMM_B3_DEC;
        Rules[0x051f] = XMM_B3_32_DEC;
        Rules[0x0520] = XMM_B3_64_DEC;
        Rules[0x0521] = XMM_N_DEC;
        Rules[0x0522] = XMM_N_32_DEC;
        Rules[0x0523] = XMM_N_64_DEC;
        Rules[0x0524] = XMM_N3_DEC;
        Rules[0x0525] = XMM_N3_32_DEC;
        Rules[0x0526] = XMM_N3_64_DEC;
        Rules[0x0527] = XMM_R_DEC;
        Rules[0x0528] = XMM_R_32_DEC;
        Rules[0x0529] = XMM_R_64_DEC;
        Rules[0x052a] = XMM_R3_DEC;
        Rules[0x052b] = XMM_R3_32_DEC;
        Rules[0x052c] = XMM_R3_64_DEC;
        Rules[0x052d] = XMM_SE_DEC;
        Rules[0x052e] = XMM_SE32_DEC;
        Rules[0x052f] = XMM_SE64_DEC;
        Rules[0x0332] = XOP_MAP_ENC_ENC;
        Rules[0x0333] = XOP_REXXB_ENC_ENC;
        Rules[0x0334] = XOP_TYPE_ENC_ENC;
        Rules[0x0535] = YMM_B_DEC;
        Rules[0x0536] = YMM_B_32_DEC;
        Rules[0x0537] = YMM_B_64_DEC;
        Rules[0x0538] = YMM_B3_DEC;
        Rules[0x0539] = YMM_B3_32_DEC;
        Rules[0x053a] = YMM_B3_64_DEC;
        Rules[0x053b] = YMM_N_DEC;
        Rules[0x053c] = YMM_N_32_DEC;
        Rules[0x053d] = YMM_N_64_DEC;
        Rules[0x053e] = YMM_N3_DEC;
        Rules[0x053f] = YMM_N3_32_DEC;
        Rules[0x0540] = YMM_N3_64_DEC;
        Rules[0x0541] = YMM_R_DEC;
        Rules[0x0542] = YMM_R_32_DEC;
        Rules[0x0543] = YMM_R_64_DEC;
        Rules[0x0544] = YMM_R3_DEC;
        Rules[0x0545] = YMM_R3_32_DEC;
        Rules[0x0546] = YMM_R3_64_DEC;
        Rules[0x0547] = YMM_SE_DEC;
        Rules[0x0548] = YMM_SE32_DEC;
        Rules[0x0549] = YMM_SE64_DEC;
        Rules[0x054a] = ZMM_B3_DEC;
        Rules[0x054b] = ZMM_B3_32_DEC;
        Rules[0x054c] = ZMM_B3_64_DEC;
        Rules[0x054d] = ZMM_N3_DEC;
        Rules[0x054e] = ZMM_N3_32_DEC;
        Rules[0x054f] = ZMM_N3_64_DEC;
        Rules[0x0550] = ZMM_R3_DEC;
        Rules[0x0551] = ZMM_R3_32_DEC;
        Rules[0x0552] = ZMM_R3_64_DEC;
        Rules[0x0553] = XSAVE_DEC;
        Rules[0x0353] = XSAVE_ENC;
