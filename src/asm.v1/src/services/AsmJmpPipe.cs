...
namespace Z0.Asm
{
    ...
    {
        // public Index<AsmJmpRow> EmitRows(ReadOnlySpan<AsmRoutine> src, FilePath dst)
        // {
        ...
        // void Store(ReadOnlySpan<AsmJmpRow> src, FilePath dst)
        // {
        //     if(src.Length != 0)
        //     {
        //         var flow = Channel.EmittingTable<AsmJmpRow>(dst);
        ...
        // [Op]
        // static AsmJmpRow jmprow(in ApiInstruction src, JccKind jk, out AsmJmpRow dst)
        // {
        ...
        // [Op]
        // static JccKind classify(IceMnemonic src, out JccKind kind)
        // {
        //     kind = K.None;
        //     switch(src)
        //     {
