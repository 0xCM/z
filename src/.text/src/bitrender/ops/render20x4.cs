...
namespace Z0
{
    ...
    {
        /// <summary>
        /// Renders 20 1-bit values interspersed with 4 separators consuming 24 characters in the target buffer
        /// </summary>
        ...
        public static uint render20x4(char sep, uint src, ref uint i, Span<char> dst)
        {
            var i0=i;
