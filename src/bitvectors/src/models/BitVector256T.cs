    ...
    where T : unmanaged
{
    ...
    [MethodImpl(Inline)]
    public static BitVector256<T> operator &(BitVector256<T> x, BitVector256<T> y)
        => api.and(x,y);
    ...
    [MethodImpl(Inline)]
    public static BitVector256<T> operator ~(BitVector256<T> src)
        => api.not(src);
    ...
    /// <param name="x">The source operand</param>
    [MethodImpl(Inline)]
    public static BitVector256<T> operator <<(BitVector256<T> x, int count)
    ...
    [MethodImpl(Inline)]
    public static bit operator *(BitVector256<T> x, BitVector256<T> y)
        => api.dot(x,y);
    ...
    [MethodImpl(Inline)]
    public static bool operator true(BitVector256<T> src)
        => src.NonEmpty;
    ...
    /// <param name="src">The source vector</param>
    [MethodImpl(Inline)]
    public static bool operator false(BitVector256<T> src)
        => src.Empty;
