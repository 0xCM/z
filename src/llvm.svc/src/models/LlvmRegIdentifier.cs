...
namespace Z0
{
    ...
    public readonly record struct LlvmRegIdentifier : IListItem<LlvmRegIdentifier,ushort,asci16>
    {
        ...
        [MethodImpl(Inline)]
        public LlvmRegIdentifier(ushort id, asci16 name)
        {
            Id = id;
            Name = name;
        }
        ...
        public bool Equals(LlvmRegIdentifier src)
            => Id == src.Id && Name == src.Name;

        [MethodImpl(Inline)]
        public int CompareTo(LlvmRegIdentifier src)
            => Id.CompareTo(src.Id);
    }
}