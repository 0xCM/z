...
namespace Z0
{
    ...
    public readonly struct ApiIdentityBuilder
    {
        ...
        [MethodImpl(Inline)]
        public static _OpIdentity NumericOp(string opname, NumericKind k, bool generic = false)
        ...
        [MethodImpl(Inline)]
        public static _OpIdentity NumericOp<T>(string opname, bool generic = true)
            where T : unmanaged
        ...
        public static _OpIdentity numeric(string opname, NumericKind k, bool generic = false)
            => build(opname, NativeTypeWidth.None, k, generic);

        public static _OpIdentity kind<K,T>(K kind, T t = default)
            where K : unmanaged
            where T : unmanaged
                => build(kind.ToString().ToLower(), (NativeTypeWidth)width<T>(), NumericKinds.kind<T>(), true);

        public static _OpIdentity klass<K,T>(K @class, T t = default)
        ...
        [Op]
        public static _OpIdentity build(string opname, NativeTypeWidth tw, NumericKind k,  bool generic)
        {
        ...
        /// <param name="k">The primal kind over which the identifier is deined</param>
        [Op]
        public static _OpIdentity build(string opname, NumericKind k, bool generic)
            => build(opname, NativeTypeWidth.None, k, generic);

        [Op]
        public static _OpIdentity build(ApiClassKind k, NumericKind nk, bool generic)
        ...
        /// <typeparam name="T">The cell type</typeparam>
        [MethodImpl(Inline)]
        public static _OpIdentity build<W,T>(string opname, W w = default, T t = default)
            where W : unmanaged, ITypeWidth
            where T : unmanaged
