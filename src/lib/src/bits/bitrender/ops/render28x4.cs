...
namespace Z0
{
    ...
    {
        /// <summary>
        /// Renders 28 1-bit values interspersed with 6 separators consuming 34 characters in the target buffer
        /// </summary>
        ...
        public static uint render28x4(char sep, uint src, ref uint i, Span<char> dst)
        {
            var i0=i;
