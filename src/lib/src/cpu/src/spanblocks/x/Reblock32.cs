...
namespace Z0
{
    partial class XSb
    {
        ...
        public static SpanBlock8<T> Reblock<T>(this SpanBlock32<T> src, W8 w)
             where T : unmanaged
        ...
        /// <typeparam name="T">The cell type</typeparam>
        [MethodImpl(Inline), Op, Closures(Closure)]
        public static SpanBlock16<T> Reblock<T>(this SpanBlock32<T> src, W16 w)
             where T : unmanaged
        ...
        /// <typeparam name="T">The cell type</typeparam>
        [MethodImpl(Inline), Op, Closures(Closure)]
        public static SpanBlock64<T> Reblock<T>(this SpanBlock32<T> src, W64 w)
             where T : unmanaged
        ...
        /// <typeparam name="T">The cell type</typeparam>
        [MethodImpl(Inline), Op, Closures(Closure)]
        public static SpanBlock128<T> Reblock<T>(this SpanBlock32<T> src, W128 w)
             where T : unmanaged
        ...
        /// <typeparam name="T">The cell type</typeparam>
        [MethodImpl(Inline), Op, Closures(Closure)]
        public static SpanBlock256<T> Reblock<T>(this SpanBlock32<T> src, W256 w)
             where T : unmanaged
        ...
        /// <typeparam name="T">The cell type</typeparam>
        [MethodImpl(Inline), Op, Closures(Closure)]
        public static SpanBlock512<T> Reblock<T>(this SpanBlock32<T> src, W512 w)
             where T : unmanaged
