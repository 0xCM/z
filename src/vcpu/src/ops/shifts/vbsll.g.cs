...
partial class vgcpu
{
    ...
    [MethodImpl(Inline), Op, Closures(Integers)]
    public static Vector512<T> vbsll<T>(Vector512<T> x, [Imm] byte count)
        where T : unmanaged
            => vbsll_u(x,count);
        ...
        where T : unmanaged
    {
        if(typeof(T) == typeof(byte))
            return generic<T>(vcpu.vbsll(v8u(x), count));
        else if(typeof(T) == typeof(ushort))
            return generic<T>(vcpu.vbsll(v16u(x), count));
        else if(typeof(T) == typeof(uint))
            return generic<T>(vcpu.vbsll(v32u(x), count));
        else if(typeof(T) == typeof(ulong))
            return generic<T>(vcpu.vbsll(v64u(x), count));
        else
        ...
        where T : unmanaged
    {
        if(typeof(T) == typeof(sbyte))
            return generic<T>(vcpu.vbsll(v8i(x), count));
        else if(typeof(T) == typeof(short))
            return generic<T>(vcpu.vbsll(v16i(x), count));
        else if(typeof(T) == typeof(int))
            return generic<T>(vcpu.vbsll(v32i(x), count));
        else if(typeof(T) == typeof(long))
            return generic<T>(vcpu.vbsll(v64i(x), count));
        else
            throw no<T>();
    }
    ...
    [MethodImpl(Inline)]
    static Vector512<T> vbsll_u<T>(Vector512<T> x, [Imm] byte count)
        where T : unmanaged
    {
        if(typeof(T) == typeof(byte))
            return generic<T>(vcpu.vbsll(v8u(x), count));
    ...
    [MethodImpl(Inline)]
    static Vector512<T> vbsll_i<T>(Vector512<T> x, [Imm] byte count)
        where T : unmanaged
    {
        if(typeof(T) == typeof(sbyte))
            return generic<T>(vcpu.vbsll(v8i(x), count));
