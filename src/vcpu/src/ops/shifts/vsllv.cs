...
partial class vcpu 
{
    ...
    {
        var x = vmovsxbw(w256, src);
        var y = vmovsxbw(w256, counts);
    ...
    {
        var a = vmovsxwd(w256, src);
        var b = v32u(vmovsxwd(w256, counts));
    ...
    {
        var a = vmovzxwd(w256, src);
        var b = vmovzxwd(w256, counts);
