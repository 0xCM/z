...
partial class vcpu 
{
    ...
    {
        if(count >= 64)
            return vsrl(vsrl128(src, 8), (byte)(count - 64));
        else
            return vor(vsrl(src, count), vsll(vsrl128(src, 8), (byte)(64 - count)));
    }
    ...
    {
        if(count >= 64)
            return vsrl(vsrl2x128(src, 8), (byte)(count - 64));
        else
            return vor(vsrl(src, count), vsll(vsrl2x128(src, 8), (byte)(64 - count)));
    }
