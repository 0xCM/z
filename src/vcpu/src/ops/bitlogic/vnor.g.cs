    ...
    partial class vgcpu
    {
            ...
            where T : unmanaged
        {
            if(typeof(T) == typeof(byte))
                return generic<T>(vcpu.vnor(v8u(x), v8u(y)));
            else if(typeof(T) == typeof(ushort))
                return generic<T>(vcpu.vnor(v16u(x), v16u(y)));
            else if(typeof(T) == typeof(uint))
                return generic<T>(vcpu.vnor(v32u(x), v32u(y)));
            else if(typeof(T) == typeof(ulong))
                return generic<T>(vcpu.vnor(v64u(x), v64u(y)));
            else
                return vnor_i(x,y);
        }
            ...
            where T : unmanaged
        {
            if(typeof(T) == typeof(sbyte))
                return generic<T>(vcpu.vnor(v8i(x), v8i(y)));
            else if(typeof(T) == typeof(short))
                return generic<T>(vcpu.vnor(v16i(x), v16i(y)));
            else if(typeof(T) == typeof(int))
                return generic<T>(vcpu.vnor(v32i(x), v32i(y)));
            else if(typeof(T) == typeof(long))
                return generic<T>(vcpu.vnor(v64i(x), v64i(y)));
            else
                return vnor_f(x,y);
        }
            ...
            where T : unmanaged
        {
            if(typeof(T) == typeof(float))
                return generic<T>(vcpu.vnor(v32f(x), v32f(y)));
            else if(typeof(T) == typeof(double))
                return generic<T>(vcpu.vnor(v64f(x), v64f(y)));
            else
                throw no<T>();
        }
