    ...
    partial class vgcpu
    {
            ...
            where T : unmanaged
        {
            if(typeof(T) == typeof(byte))
                return generic<T>(vcpu.vxnor(v8u(x), v8u(y)));
            else if(typeof(T) == typeof(ushort))
                return generic<T>(vcpu.vxnor(v16u(x), v16u(y)));
            else if(typeof(T) == typeof(uint))
                return generic<T>(vcpu.vxnor(v32u(x), v32u(y)));
            else if(typeof(T) == typeof(ulong))
                return generic<T>(vcpu.vxnor(v64u(x), v64u(y)));
            else
                return vxnor_i(x,y);
        }
            ...
            where T : unmanaged
        {
            if(typeof(T) == typeof(sbyte))
                return generic<T>(vcpu.vxnor(v8i(x), v8i(y)));
            else if(typeof(T) == typeof(short))
                return generic<T>(vcpu.vxnor(v16i(x), v16i(y)));
