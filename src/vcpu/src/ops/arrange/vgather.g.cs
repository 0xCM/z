    ...
    partial class vgcpu
    {
            ...
            where T : unmanaged
        {
            if(typeof(T) == typeof(byte))
                return generic<T>(vcpu.vgather(w, u8(src), v8u(vidx)));
            else if(typeof(T) == typeof(ushort))
                return generic<T>(vcpu.vgather(w, u16(src), v16u(vidx)));
            else if(typeof(T) == typeof(uint))
                return generic<T>(vcpu.vgather(w, u32(src), v32u(vidx)));
            else if(typeof(T) == typeof(ulong))
                return generic<T>(vcpu.vgather(w, u64(src), v64u(vidx)));
            else
            ...
            where T : unmanaged
        {
            if(typeof(T) == typeof(sbyte))
                return generic<T>(vcpu.vgather(w, i8(src), v8i(vidx)));
            else if(typeof(T) == typeof(short))
                return generic<T>(vcpu.vgather(w, i16(src), v16i(vidx)));
            else if(typeof(T) == typeof(int))
                return generic<T>(vcpu.vgather(w, i32(src), v32i(vidx)));
            else if(typeof(T) == typeof(long))
                return generic<T>(vcpu.vgather(w, i64(src), v64i(vidx)));
            else
                throw no<T>();
        }
