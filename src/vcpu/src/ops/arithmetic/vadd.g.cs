...
partial class vgcpu
{
    ...
    public static Vector128<T> vadd<T>(Vector128<T> x, T a)
        where T : unmanaged
            => vadd(x, vgcpu.vbroadcast(n128,a));
    ...
    public static Vector256<T> vadd<T>(Vector256<T> x, T a)
        where T : unmanaged
            => vadd(x, vgcpu.vbroadcast(n256,a));
        ...
        where T : unmanaged
    {
        if(typeof(T) == typeof(byte))
            return generic<T>(vcpu.vadd(v8u(x), v8u(y)));
        else if(typeof(T) == typeof(ushort))
            return generic<T>(vcpu.vadd(v16u(x), v16u(y)));
        else if(typeof(T) == typeof(uint))
            return generic<T>(vcpu.vadd(v32u(x), v32u(y)));
        else if(typeof(T) == typeof(ulong))
            return generic<T>(vcpu.vadd(v64u(x), v64u(y)));
        else
            return vadd_i(x,y);
    }
        ...
        where T : unmanaged
    {
        if(typeof(T) == typeof(sbyte))
                return generic<T>(vcpu.vadd(v8i(x), v8i(y)));
        else if(typeof(T) == typeof(short))
                return generic<T>(vcpu.vadd(v16i(x), v16i(y)));
        else if(typeof(T) == typeof(int))
                return generic<T>(vcpu.vadd(v32i(x), v32i(y)));
        else if(typeof(T) == typeof(long))
                return generic<T>(vcpu.vadd(v64i(x), v64i(y)));
        else
            return vadd_f(x,y);
    }
        ...
        where T : unmanaged
    {
        if(typeof(T) == typeof(float))
            return generic<T>(fcpu.vadd(v32f(x), v32f(y)));
        else if(typeof(T) == typeof(double))
            return generic<T>(fcpu.vadd(v64f(x), v64f(y)));
        else
            throw no<T>();
    }
        ...
        where T : unmanaged
    {
        if(typeof(T) == typeof(sbyte))
            ...
            return gfcpu.vadd(x,y);
    }

    [MethodImpl(Inline)]
    static Vector512<T> vadd_u<T>(Vector512<T> x, Vector512<T> y)
        where T : unmanaged
    {
        if(typeof(T) == typeof(byte))
            return generic<T>(vcpu.vadd(v8u(x), v8u(y)));
    ...
    [MethodImpl(Inline)]
    static Vector512<T> vadd_i<T>(Vector512<T> x, Vector512<T> y)
        where T : unmanaged
    {
        if(typeof(T) == typeof(sbyte))
            return generic<T>(vcpu.vadd(v8i(x), v8i(y)));
