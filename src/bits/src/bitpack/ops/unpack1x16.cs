...
namespace Z0
{
    ...
    partial struct BitPack
    {
        ...
        /// <param name="dst">The bit target</param>
        [MethodImpl(Inline), Unpack]
        public static void unpack1x16x8(ushort src, SpanBlock128<byte> dst)
        ...
        [MethodImpl(Inline), Op]
        public static SpanBlock128<byte> unpack1x16x8(ushort src, SpanBlock128<byte> dst, int block)
        {
