...
namespace Z0
{
    ...
    partial class BitGrid
    {
        ...
        /// <typeparam name="T">The cell type</typeparam>
        [MethodImpl(Inline), Xnor, Closures(UnsignedInts)]
        public static BitSpanBlocks256<T> xnor<T>(in BitSpanBlocks256<T> gx, in BitSpanBlocks256<T> gy, in BitSpanBlocks256<T> gz)
            where T : unmanaged
        {
        ...
        /// <typeparam name="T">The cell type</typeparam>
        [MethodImpl(Inline)]
        public static BitGrid<M,N,T> xnor<M,N,T>(in BitGrid<M,N,T> gx, in BitGrid<M,N,T> gy, in BitGrid<M,N,T> gz)
            where T : unmanaged
            where M : unmanaged, ITypeNat
            where N : unmanaged, ITypeNat
        {
