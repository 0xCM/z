...
namespace Z0
{
    ...
    /// </summary>
    public readonly struct asci8 : IAsciSeq<A,N>, IUnmanaged<A>
    {
        ...
        public Vector128<byte> EncodedVector()
            => vcpu.v8u(vcpu.vscalar(w128,Storage));
