...
namespace Z0
{
    ...
    public sealed class Assets
    {
        ...
        public static ReadOnlySeq<ResourceName> ManifestNames(Assembly src)
        {
        ...
        public static ReadOnlySeq<AssetCatalogEntry> entries(ReadOnlySeq<Asset> src)
        {
        ...
        public static unsafe ComponentAssets extract(Assembly src)
        {
            ...
            for(var i=0u; i<count; i++)
            {
                ...
                dst[i] = asset(src, names[i], stream.PositionPointer, (uint)stream.Length);
            }
            return dst;
        }

        [MethodImpl(Inline), Op]
        public static ReadOnlySeq<ComponentAssets> extract(ReadOnlySpan<Assembly> src)
        {
