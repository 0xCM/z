...
namespace Roslyn.Utilities
{
    ...
    public static class PathUtilities
    {
        ...
        public static readonly string DirectorySeparatorStr = new(DirectorySeparatorChar, 1);
        public const char VolumeSeparatorChar = ':';
        public static bool IsUnixLikePlatform => false;
        ...
        [return: NotNullIfNotNull("path")]
        public static string? GetDirectoryName(string? path, bool isUnixLike)
        {
            if (path != null)
            {
        ...
        private static int PathHashCode(string? path)
        {
            ...
            if (path != null)
            {
                foreach (var ch in path)
                {
                    ...
                    {
                        hc = sys.nhash(char.ToUpperInvariant(ch), hc);
                    }
                }
            }
