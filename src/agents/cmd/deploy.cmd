@echo off
call %~dp0..\config.cmd
set DeployProps=-p:PublishReadyToRun=true -p:DebugType=embedded -p:PublishSingleFile=true -p:PublishDocumentationFiles=false -p:IncludeNativeLibrariesInSingleFile=true
