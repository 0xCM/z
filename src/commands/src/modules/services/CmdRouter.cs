...
namespace Z0
{
    public class CmdRouter : IWfDispatcher
    {
        IWfOps _Commands;
        ...
        [MethodImpl(Inline)]
        public CmdRouter(IWfChannel channel, ReadOnlySeq<ICmdProvider> providers, IWfOps lookup)
        {
            _Commands = lookup;
            Fallback = NotFound;
            Channel = channel;
        ...
        public IWfOps Commands => _Commands;
