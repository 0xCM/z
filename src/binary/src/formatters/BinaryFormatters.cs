...
namespace Z0
{
    ...
    public partial class BinaryFormatters
    {                    
        ...
        static uint EncodeText(string src, uint offset, Span<byte> dst)
        {
        ...
        static uint DecodeText(ReadOnlySpan<byte> src, uint offset, out string dst)
        {
