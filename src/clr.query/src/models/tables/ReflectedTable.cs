...
namespace Z0
{
    ...
    public class ReflectedTable : IComparable<ReflectedTable>
    {
        ...
        public readonly Index<ReflectedField> Fields;
        ...
        [MethodImpl(Inline)]
        public ReflectedTable(Type type, TableId id, ReflectedField[] fields, LayoutKind? layout, CharSet? charset, byte? pack, uint? size)
        {
