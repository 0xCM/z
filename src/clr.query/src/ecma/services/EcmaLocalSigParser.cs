...
namespace Z0
{
    ...
    public class EcmaLocalSigParser : EcmaSigParser
    {
        ...
        public EcmaLocalSigParser(ICilTokenResolver tokenResolver, ICilTypeFactory typeFactory)
        {
        ...
        class TypeCreator
        {
            readonly EcmaLocalSigParser _parent;

            Inner _inner;

            bool _byRef;

            public TypeCreator(EcmaLocalSigParser parent)
            {
                _parent = parent;
            }
