...
namespace Z0
{
    ...
    partial struct zUInt128
    {
        ...
        [MethodImpl(Inline), Mul]
        public static Pair<uint> mul(uint a, uint b, out Pair<uint> dst)
        {
        ...
        [MethodImpl(Inline), Mul]
        public static unsafe ref zUInt128 mul(ref zUInt128 dst, in zUInt128 src)
        {
        ...
        [MethodImpl(Inline), Mul]
        public static zUInt128 mul(ulong x, ulong y, out zUInt128 dst)
        {
        ...
        {
            var count = sys.min(sys.min(a.Length, b.Length), dst.Length);
