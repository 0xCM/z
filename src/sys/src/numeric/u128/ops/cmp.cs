...
namespace Z0
{
    partial struct UInt128
    {
        ...
        public static bool eq(in UInt128 x, in UInt128 y)
            => x.Lo == y.Lo && x.Hi == y.Hi;
        ...
        public static bool lt(in UInt128 x, in UInt128 y)
        ...
        public static bool lteq(in UInt128 x, in UInt128 y)
            => x.Hi < y.Hi | ((x.Hi == y.Hi) && (x.Lo <= y.Lo));
        ...
        public static bool gt(in UInt128 x, in UInt128 y)
            => !lteq(x,y);
        ...
        public static bool gteq(in UInt128 x, in UInt128 y)
            => !lt(x,y);
    }
}