...
public class t_vshuffle : t_inx<t_vshuffle>
{
    public void vshuf16x8_128x8u()
    {
        ...
        VClaim.veq(x5Dst, vbroadcast(w,(byte)0));
    }
    ...
    public void vshuf16x16()
    {
        ...
        VClaim.veq(reverse, y1);

        var y2 = vshuf16x16(x,identity);
        VClaim.veq(identity,y2);

        var y3 = vshuf16x16(x,pairswap);
        VClaim.veq(pairswap,y3);
    }
