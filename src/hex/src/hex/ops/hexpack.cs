...
{
    // [Op]
    // public static ByteSize hexpack(Index<MemorySegment> src, StreamWriter dst)
    // {
    ...
    //         var charcount = pack(seg.View, buffer);
    ...
    // [Op]
    // public static ByteSize hexpack(MemorySegment src, uint bpl, StreamWriter dst)
    // {
