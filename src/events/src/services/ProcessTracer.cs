...
namespace Z0
{
    ...
    public class ProcessTracer : Channeled<ProcessTracer>, IMonitor
    {
        ...
        ICsvFormatter<ProcessStartEvent> StartEventFormatter;
        ...
        public void Start()
        {
            ...
            if(Flow == null)
            {
                sys.start(() => {
                    ...
                    {
                        //Channel.RowFormat("Process {0,16} At 0x{1,8:x} Loaded {2}", data.ProcessName, data.ImageBase, data.FileName);
                    };
                    ...
                    {
                        Channel.RowFormat("Process Ending {0,-6} {1}", data.ProcessID, data.ProcessName);
                    };
