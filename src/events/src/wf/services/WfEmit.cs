...
{    
    ...
    public static WfChannel create(IEventBroker broker, IEmissionLog emissions, Type host)
    ...
    readonly IEmissionLog Emissions;

    WfChannel(IEventBroker broker, IEmissionLog emissions, Type host)
    {
